...
const bankAction = require('../services/bank/action/bank');
const productAction = require('../services/product/action/product');
...
const saveEmiDetails = async (data) => {
    ...
    const emi = {
        ...
        principal_emi: data.Principal_Amount,
        interest_emi: data.Interest_Amount,
